...
typedef SessionOptions = {
	...
	**/
	var secret : ts.AnyOf2<String, Array<String>>;
	/**
	...
	**/
	@:optional
	function genid(req:express.Request<express_serve_static_core.ParamsDictionary, Dynamic, Dynamic, qs.ParsedQs, haxe.DynamicAccess<Dynamic>>):String;
	/**
