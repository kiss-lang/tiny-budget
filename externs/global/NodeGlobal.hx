...
@:native("") extern class NodeGlobal {
	static function structuredClone<T>(value:T, ?transfer:{ var transfer : haxe.ds.ReadOnlyArray<node.worker_threads.TransferListItem>; }):T;
	...
	**/
	static function clearImmediate(immediateId:Null<global.nodejs.Immediate>):Void;
	static var global : {
		/**
		...
		**/
		...
		function structuredClone<T>(value:T, ?transfer:{ var transfer : haxe.ds.ReadOnlyArray<node.worker_threads.TransferListItem>; }):T;
		...
		**/
		...
		/**
			Cancels an `Immediate` object created by `setImmediate()`.
		**/
		function clearImmediate(immediateId:Null<global.nodejs.Immediate>):Void;
