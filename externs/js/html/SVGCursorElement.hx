...
@:native("SVGCursorElement") extern class SVGCursorElement {
	function new();
	final x : js.html.svg.AnimatedLength;
	final y : js.html.svg.AnimatedLength;
	/**
	...
	**/
	...
	final ownerSVGElement : Null<js.html.svg.SVGElement>;
	final viewportElement : Null<js.html.svg.Element>;
	...
	**/
	...
	final correspondingElement : js.html.svg.Element;
	final correspondingUseElement : js.html.svg.UseElement;
	static var prototype : SVGCursorElement;
}