...
**/
@:native("HTMLMarqueeElement") extern class HTMLMarqueeElement {
	function new();
	var behavior : String;
	var bgColor : String;
	...
	var loop : Float;
	@:optional
	dynamic function onbounce(ev:js.html.Event):Dynamic;
	@:optional
	dynamic function onfinish(ev:js.html.Event):Dynamic;
	@:optional
	dynamic function onstart(ev:js.html.Event):Dynamic;
	...
	**/
	...
	static var prototype : HTMLMarqueeElement;
}