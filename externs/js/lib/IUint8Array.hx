...
typedef IUint8Array = {
	...
	**/
	function copyWithin(target:Float, start:Float, ?end:Float):js.lib.Uint8Array;
	/**
	...
	**/
	function fill(value:Float, ?start:Float, ?end:Float):js.lib.Uint8Array;
	/**
	...
	**/
	...
	/**
		Sorts an array.
	**/
	function sort(?compareFn:(a:Float, b:Float) -> Float):js.lib.Uint8Array;
	/**
