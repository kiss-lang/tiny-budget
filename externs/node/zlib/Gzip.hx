...
typedef Gzip = {
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):Gzip;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):Gzip { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):Gzip { })
	function end(?cb:() -> Void):Gzip;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Gzip { })
	@:overload(function(event:String, listener:() -> Void):Gzip { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Gzip { })
	@:overload(function(event:String, listener:() -> Void):Gzip { })
	@:overload(function(event:String, listener:() -> Void):Gzip { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Gzip { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):Gzip;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):Gzip;
	...
	**/
	function destroy(?error:js.lib.Error):Gzip;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<Gzip, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Gzip;
	/**
