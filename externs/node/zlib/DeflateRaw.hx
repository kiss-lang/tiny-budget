...
typedef DeflateRaw = {
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):DeflateRaw;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):DeflateRaw { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):DeflateRaw { })
	function end(?cb:() -> Void):DeflateRaw;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):DeflateRaw { })
	@:overload(function(event:String, listener:(err:js.lib.Error) -> Void):DeflateRaw { })
	@:overload(function(event:String, listener:() -> Void):DeflateRaw { })
	@:overload(function(event:String, listener:() -> Void):DeflateRaw { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):DeflateRaw { })
	@:overload(function(event:String, listener:() -> Void):DeflateRaw { })
	@:overload(function(event:String, listener:() -> Void):DeflateRaw { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):DeflateRaw { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):DeflateRaw;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):DeflateRaw;
	...
	**/
	function destroy(?error:js.lib.Error):DeflateRaw;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<DeflateRaw, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):DeflateRaw;
	/**
