...
typedef Deflate = {
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):Deflate;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):Deflate { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):Deflate { })
	function end(?cb:() -> Void):Deflate;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Deflate { })
	@:overload(function(event:String, listener:(err:js.lib.Error) -> Void):Deflate { })
	@:overload(function(event:String, listener:() -> Void):Deflate { })
	@:overload(function(event:String, listener:() -> Void):Deflate { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Deflate { })
	@:overload(function(event:String, listener:() -> Void):Deflate { })
	@:overload(function(event:String, listener:() -> Void):Deflate { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Deflate { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):Deflate;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):Deflate;
	...
	**/
	function destroy(?error:js.lib.Error):Deflate;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<Deflate, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Deflate;
	/**
