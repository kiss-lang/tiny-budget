...
typedef Unzip = {
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):Unzip;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):Unzip { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):Unzip { })
	function end(?cb:() -> Void):Unzip;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Unzip { })
	@:overload(function(event:String, listener:() -> Void):Unzip { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Unzip { })
	@:overload(function(event:String, listener:() -> Void):Unzip { })
	@:overload(function(event:String, listener:() -> Void):Unzip { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Unzip { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):Unzip;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):Unzip;
	...
	**/
	function destroy(?error:js.lib.Error):Unzip;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<Unzip, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Unzip;
	/**
