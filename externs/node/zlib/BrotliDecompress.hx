...
typedef BrotliDecompress = {
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):BrotliDecompress;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):BrotliDecompress { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):BrotliDecompress { })
	function end(?cb:() -> Void):BrotliDecompress;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):BrotliDecompress { })
	@:overload(function(event:String, listener:(err:js.lib.Error) -> Void):BrotliDecompress { })
	@:overload(function(event:String, listener:() -> Void):BrotliDecompress { })
	@:overload(function(event:String, listener:() -> Void):BrotliDecompress { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):BrotliDecompress { })
	@:overload(function(event:String, listener:() -> Void):BrotliDecompress { })
	@:overload(function(event:String, listener:() -> Void):BrotliDecompress { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):BrotliDecompress { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):BrotliDecompress;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):BrotliDecompress;
	...
	**/
	function destroy(?error:js.lib.Error):BrotliDecompress;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<BrotliDecompress, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):BrotliDecompress;
	/**
