...
typedef BrotliCompress = {
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):BrotliCompress;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):BrotliCompress { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):BrotliCompress { })
	function end(?cb:() -> Void):BrotliCompress;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):BrotliCompress { })
	@:overload(function(event:String, listener:() -> Void):BrotliCompress { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):BrotliCompress { })
	@:overload(function(event:String, listener:() -> Void):BrotliCompress { })
	@:overload(function(event:String, listener:() -> Void):BrotliCompress { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):BrotliCompress { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):BrotliCompress;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):BrotliCompress;
	...
	**/
	function destroy(?error:js.lib.Error):BrotliCompress;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<BrotliCompress, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):BrotliCompress;
	/**
