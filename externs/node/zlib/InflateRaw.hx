...
typedef InflateRaw = {
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):InflateRaw;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):InflateRaw { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):InflateRaw { })
	function end(?cb:() -> Void):InflateRaw;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):InflateRaw { })
	@:overload(function(event:String, listener:() -> Void):InflateRaw { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):InflateRaw { })
	@:overload(function(event:String, listener:() -> Void):InflateRaw { })
	@:overload(function(event:String, listener:() -> Void):InflateRaw { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):InflateRaw { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):InflateRaw;
	/**
	...
	**/
	function destroy(?error:js.lib.Error):InflateRaw;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<InflateRaw, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
