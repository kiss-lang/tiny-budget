...
typedef Inflate = {
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):Inflate;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):Inflate { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):Inflate { })
	function end(?cb:() -> Void):Inflate;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Inflate { })
	@:overload(function(event:String, listener:() -> Void):Inflate { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Inflate { })
	@:overload(function(event:String, listener:() -> Void):Inflate { })
	@:overload(function(event:String, listener:() -> Void):Inflate { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Inflate { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):Inflate;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):Inflate;
	...
	**/
	function destroy(?error:js.lib.Error):Inflate;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<Inflate, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Inflate;
	/**
