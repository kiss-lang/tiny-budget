...
@:jsRequire("dgram", "Socket") extern class Socket extends node.Events {
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Socket { })
	@:overload(function(event:String, listener:(msg:node.buffer.Buffer, rinfo:RemoteInfo) -> Void):Socket { })
	...
	**/
	...
	@:overload(function(event:String):Bool { })
	@:overload(function(event:String, msg:node.buffer.Buffer, rinfo:RemoteInfo):Bool { })
