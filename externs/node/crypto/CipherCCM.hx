...
typedef CipherCCM = {
	...
	**/
	function setAutoPadding(?autoPadding:Bool):CipherCCM;
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):CipherCCM;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):CipherCCM { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):CipherCCM { })
	function end(?cb:() -> Void):CipherCCM;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):CipherCCM { })
	@:overload(function(event:String, listener:() -> Void):CipherCCM { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):CipherCCM { })
	@:overload(function(event:String, listener:() -> Void):CipherCCM { })
	@:overload(function(event:String, listener:() -> Void):CipherCCM { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):CipherCCM { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):CipherCCM;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):CipherCCM;
	...
	**/
	function destroy(?error:js.lib.Error):CipherCCM;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<CipherCCM, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):CipherCCM;
	/**
