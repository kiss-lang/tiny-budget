...
typedef DecipherCCM = {
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):DecipherCCM;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):DecipherCCM { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):DecipherCCM { })
	function end(?cb:() -> Void):DecipherCCM;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):DecipherCCM { })
	@:overload(function(event:String, listener:(err:js.lib.Error) -> Void):DecipherCCM { })
	@:overload(function(event:String, listener:() -> Void):DecipherCCM { })
	@:overload(function(event:String, listener:() -> Void):DecipherCCM { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):DecipherCCM { })
	@:overload(function(event:String, listener:() -> Void):DecipherCCM { })
	@:overload(function(event:String, listener:() -> Void):DecipherCCM { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):DecipherCCM { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):DecipherCCM;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):DecipherCCM;
	...
	**/
	function destroy(?error:js.lib.Error):DecipherCCM;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<DecipherCCM, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):DecipherCCM;
	/**
