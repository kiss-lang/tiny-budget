...
typedef DecipherGCM = {
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):DecipherGCM;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):DecipherGCM { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):DecipherGCM { })
	function end(?cb:() -> Void):DecipherGCM;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):DecipherGCM { })
	@:overload(function(event:String, listener:() -> Void):DecipherGCM { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):DecipherGCM { })
	@:overload(function(event:String, listener:() -> Void):DecipherGCM { })
	@:overload(function(event:String, listener:() -> Void):DecipherGCM { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):DecipherGCM { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):DecipherGCM;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):DecipherGCM;
	...
	**/
	function destroy(?error:js.lib.Error):DecipherGCM;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<DecipherGCM, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):DecipherGCM;
	/**
