...
typedef CipherGCM = {
	...
	**/
	function setAutoPadding(?autoPadding:Bool):CipherGCM;
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):CipherGCM;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):CipherGCM { })
	@:overload(function(chunk:Dynamic, ?encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):CipherGCM { })
	function end(?cb:() -> Void):CipherGCM;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):CipherGCM { })
	@:overload(function(event:String, listener:() -> Void):CipherGCM { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):CipherGCM { })
	@:overload(function(event:String, listener:() -> Void):CipherGCM { })
	@:overload(function(event:String, listener:() -> Void):CipherGCM { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):CipherGCM { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):CipherGCM;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):CipherGCM;
	...
	**/
	function destroy(?error:js.lib.Error):CipherGCM;
	function pipe<T>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T>(stream:ts.AnyOf4<CipherGCM, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):CipherGCM;
	/**
