	...
	var Http1IncomingMessage : {
		...
		**/
		...
		/**
			...
			```
		**/
		function getMaxListeners(emitter:ts.AnyOf2<global.nodejs.EventEmitter, ServerSessionOptions>):Float;
		/**
			```js
			...
			```
		**/
		function setMaxListeners(?n:Float, eventTargets:haxe.extern.Rest<ts.AnyOf2<global.nodejs.EventEmitter, ServerSessionOptions>>):Void;
		/**
