...
typedef Http2Session = {
	...
	**/
	@:overload(function(payload:global.nodejs.ArrayBufferView, callback:(err:Null<js.lib.Error>, duration:Float, payload:node.buffer.Buffer) -> Void):Bool { })
	function ping(callback:(err:Null<js.lib.Error>, duration:Float, payload:node.buffer.Buffer) -> Void):Bool;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:(errorCode:Float, lastStreamID:Float, opaqueData:node.buffer.Buffer) -> Void):Http2Session { })
	...
	**/
	...
	@:overload(function(event:String, errorCode:Float, lastStreamID:Float, opaqueData:node.buffer.Buffer):Bool { })
	...
	**/
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeListener(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Http2Session;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Http2Session;
	/**
