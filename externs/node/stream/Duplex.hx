...
@:jsRequire("stream", "Duplex") extern class Duplex {
	...
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Duplex;
	/**
	...
	**/
	static function from(src:ts.AnyOf9<String, Dynamic, js.lib.ArrayBuffer, node.buffer.Blob, Stream, Iterable<Dynamic>, js.lib.AsyncIterable<Dynamic>, js.lib.AsyncGeneratorFunction, js.lib.Promise<Dynamic>>):Duplex;
	/**
		A utility method for creating a web `ReadableStream` and `WritableStream` from a `Duplex`.
	**/
	static function toWeb(streamDuplex:Duplex):{
		var readable : node.stream.web.ReadableStream<Dynamic>;
		var writable : node.stream.web.WritableStream<Dynamic>;
	};
	/**
		A utility method for creating a `Duplex` from a web `ReadableStream` and `WritableStream`.
	**/
	static function fromWeb(duplexStream:{ var readable : node.stream.web.ReadableStream<Dynamic>; var writable : node.stream.web.WritableStream<Dynamic>; }, ?options:{ /** When provided the corresponding `AbortController` can be used to cancel an asynchronous action. **/ @:optional var signal : js.html.AbortSignal; @:optional var encoding : global.nodejs.BufferEncoding; @:optional var highWaterMark : Float; @:optional var objectMode : Bool; @:optional var decodeStrings : Bool; @:optional var allowHalfOpen : Bool; }):Duplex;
}