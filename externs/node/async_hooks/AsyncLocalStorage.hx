...
@:jsRequire("async_hooks", "AsyncLocalStorage") extern class AsyncLocalStorage<T> {
	...
	**/
	...
	/**
		...
		```
	**/
	function run<R, TArgs>(store:T, callback:(args:haxe.extern.Rest<Any>) -> R, args:haxe.extern.Rest<Any>):R;
	/**
		...
		```
	**/
	function exit<R, TArgs>(callback:(args:haxe.extern.Rest<Any>) -> R, args:haxe.extern.Rest<Any>):R;
	/**
	...
	**/
	static function bind<Func>(fn:Func):Func;
	/**
