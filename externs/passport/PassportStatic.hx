...
typedef PassportStatic = {
	...
	**/
	@:overload(function(name:String, strategy:Strategy):PassportStatic { })
	function use(strategy:Strategy):PassportStatic;
	/**
	...
	**/
	function unuse(name:String):PassportStatic;
	/**
	...
	**/
	function initialize(?options:InitializeOptions):express.Handler;
	/**
	...
	**/
	function session(?options:SessionOptions):Dynamic;
	/**
	...
	**/
	@:overload(function(strategy:ts.AnyOf3<String, Array<String>, Strategy>, options:AuthenticateOptions, ?callback:ts.AnyOf2<AuthenticateCallback, (args:haxe.extern.Rest<Dynamic>) -> Dynamic>):Dynamic { })
	function authenticate(strategy:ts.AnyOf3<String, Array<String>, Strategy>, ?callback:ts.AnyOf2<AuthenticateCallback, (args:haxe.extern.Rest<Dynamic>) -> Dynamic>):Dynamic;
	/**
	...
	**/
	@:overload(function(strategy:ts.AnyOf2<String, Array<String>>, options:AuthenticateOptions, ?callback:ts.AnyOf2<AuthenticateCallback, (args:haxe.extern.Rest<Dynamic>) -> Dynamic>):Dynamic { })
	function authorize(strategy:ts.AnyOf2<String, Array<String>>, ?callback:ts.AnyOf2<AuthenticateCallback, (args:haxe.extern.Rest<Dynamic>) -> Dynamic>):Dynamic;
	/**
